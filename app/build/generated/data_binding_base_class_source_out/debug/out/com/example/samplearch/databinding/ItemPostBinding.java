...
public final class ItemPostBinding implements ViewBinding {
  ...
  private ItemPostBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageView imgProduct, @NonNull View separator, @NonNull TextView tvAuthor,
  ...
  public static ItemPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPostBinding((ConstraintLayout) rootView, imgProduct, separator, tvAuthor,
          tvTitle);
    }
