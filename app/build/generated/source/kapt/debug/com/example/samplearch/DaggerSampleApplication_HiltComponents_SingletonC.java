...
public final class DaggerSampleApplication_HiltComponents_SingletonC extends SampleApplication_HiltComponents.SingletonC {
  ...
  private BaseHeaderInterceptor baseHeaderInterceptor() {
    return new BaseHeaderInterceptor(networkValidatorImp());
  }

  private OkHttpClient okHttpClient() {
    return RemoteHttpModule_ProvidesOkHttpClientFactory.providesOkHttpClient(new LoggingInterceptor(), connectionInterceptor(), baseHeaderInterceptor(), ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
  }
  ...
  private static final class ViewModelCImpl extends SampleApplication_HiltComponents.ViewModelC {
    ...
    private PostsRemoteDataSource postsRemoteDataSource() {
      return new PostsRemoteDataSource(singletonC.postsApiService());
    }
